...
//
addGlobalStyle('html{background: url("http://i41.tinypic.com/6dvix3.jpg") no-repeat scroll center top #000000;');
//
...
/*
                if (isBoris())
        API.sendChat("@" + user.username + ", Hi & Welcome, enjoy your time in The Playhouse! :)) ");
*/
...
//		+ 	'<p id="plugbot-btn-userlist" style="color:#ED1C24">userlist</p>'
		+ 	'<p id="plugbot-btn-facebook" style="color:#ED1C24"><a style="color: #F88017" href="https://www.facebook.com/groups/Plug.Dj.PDP/" target="_blank">facebook</a></p>'
		+ 	'<p id="plugbot-btn-youtube" style="color:#ED1C24"><a style="color: #F88017" href="http://www.youtube.com/user/sup3r1mp3gahd/videos" target="_blank">ledges youtube</a></p>'
  	+ 	'<p id="plugbot-btn-youtube" style="color:#ED1C24"><a style="color: #F88017" href="http://www.youtube.com/user/knifepartyhd/videos" target="_blank">ledges youtube</a></p>'
		+ 	'<h2 id="plugbot-btn-minecraft" style="color:#F88017"> <a style="color:#3FFF00"> Super's Minecraft Server </a> </br> Server Status: <a style="color:#3FFF00"> Online </a> </br> Server Ip: <a style="color:#3FFF00"> mc.sspvp.com</a></h2>'
    );
}
...
//autochat
/*
function isBoris() { return API.getSelf().username == "Sυρєя"; }

if (isBoris())
{
    window.setInterval(function() {
    API.sendChat("Check out our Room's Facebook group @ http://www.facebook.com/groups/315391008573898/ and  Youtube @ http://www.youtube.com/user/knifepartyhd :) ");
    }, (1000 * 60 * 60));
}
*/
